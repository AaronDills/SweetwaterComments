...
$MISC_QUERY="SELECT * aFROM sweetwater_test WHERE comments not in (SELECT * FROM sweetwater_test WHERE comments like '%candy%' OR comments like '%call%' OR comments like '%referred%' OR comments like '%signature%')";
